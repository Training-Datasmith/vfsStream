 ...
 */
class Vfs_Stream_Container_Iterator implements Iterator
{
    /**
    ...
    public function __construct(array $children)
    {
        ...
        if (Vfs_Stream::use_dotfiles()) {
            array_unshift($this->children, new Dot_Directory('.'), new Dot_Directory('..'));
        }
        reset($this->children);
    }
    /**
     ...
     */
    public function current(): ?Vfs_Stream_Content
    {
